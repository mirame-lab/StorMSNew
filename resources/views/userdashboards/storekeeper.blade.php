                ...
                <div class="accordion-item card">
                    <button type="button" class="accordion-button collapsed" data-bs-toggle="collapse"
                        ...
                        <div class="avatar flex-shrink-0 me-3">
                            @if(!$all_req_materials[$i]["materials"][0]['SK_approval'])<span
                        ...
                        <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
                            <div class="me-2">
                                <small
                                    class="text-muted d-block mb-1">{{$all_req_materials[$i]["materials"][0]['request_id']}} | {{$all_req_materials[$i]["materials"][0]['requester_name']}}</small>
                                <div><p class="mb-0">{{$all_req_materials[$i]["materials"][0]['project_id']}}</p></div>
                            </div>
                                ...
                                <div class="demo-inline-spacing mt-3">
                                    <ul class="list-group">
                                        ...
                                        <li class="list-group-item d-flex justify-content-between align-items-center">
                                            <div class="me-2">
                                                <small
                                                    class="text-muted d-block mb-1">{{$all_req_materials[$i]["materials"][$j]['material_id']}}</small>
